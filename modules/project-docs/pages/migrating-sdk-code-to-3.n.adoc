...
----
include::example$migrating.py[tag=shutdown,indent=0]
----
...
bucket=SDK2Bucket("couchbases://127.0.0.1/default")
...
----
include::example$migrating.py[tag=customtimeout;!test,indent=0]
----
...
----
# SDK 2 simple query
query_result = bucket.query(N1qlQuery.simple("select * from `travel-sample` limit 10"));
